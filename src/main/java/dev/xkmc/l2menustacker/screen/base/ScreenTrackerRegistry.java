...
public class ScreenTrackerRegistry {
	...
	public static final Supplier<InventorySource> IS_INVENTORY = L2ScreenTracker.REGISTRATE.simple("inventory", ITEM_SOURCE.key(), InventorySource::new);
	public static final Supplier<EnderSource> IS_ENDER = L2ScreenTracker.REGISTRATE.simple("ender", ITEM_SOURCE.key(), EnderSource::new);

	public static final Supplier<InventoryTrace> TE_INVENTORY = L2ScreenTracker.REGISTRATE.simple("inventory", TRACKED_ENTRY_TYPE.key(), InventoryTrace::new);
	public static final Supplier<EnderTrace> TE_ENDER = L2ScreenTracker.REGISTRATE.simple("ender", TRACKED_ENTRY_TYPE.key(), EnderTrace::new);
	public static final Supplier<QuickAccessTrace> TE_QUICK_ACCESS = L2ScreenTracker.REGISTRATE.simple("quick_access", TRACKED_ENTRY_TYPE.key(), QuickAccessTrace::new);
	public static final Supplier<MenuProviderTrace> TE_MENU_PROVIDER = L2ScreenTracker.REGISTRATE.simple("menu_provider", TRACKED_ENTRY_TYPE.key(), MenuProviderTrace::new);
